    ...
    return(
        <div className="divSobremi" id='sobreMi'>
            <div className='text1'>
                ...
                <p className='respuesta'>Hola soy Luciano Moacchegiani Desarrollador Full Stack, con conocimientos aplicables a proyectos webs y app mobiles, a realizarse de forma escalable y modularizados para optimizar de mejor manera el trabajo en equipo.</p>
            </div>
            {/* <div className='text2'>
