...
export default function Misproyectos(){
  const [onHover,setOnHover]= useState({on:false, in:null})
    const objProyect=[
       {name:'Movies&SeriesApp',link:"https://expo.dev/artifacts/eas/c63mXaD4p77QbUfT8xdRPs.apk", imagen:imagen4, resumen: "Movies and series app:app developed with react native, expo, firebase."},
       {name:'OrderStoreApp',link:"https://expo.dev/artifacts/eas/jGKgozWyeyWPLzwadd8gYM.apk", imagen:imagen5, resumen: "App to make and manage purchase orders."},
